...
>
  ⚙️ Settings
          ...
          <div
            v-if="userEmail"
            class="hidden lg:flex items-center gap-2 bg-slate-800 border border-slate-700 rounded-xl pl-2.5 pr-3 py-1.5 text-xs text-slate-300 font-mono"
          >
            <span
              class="h-2 w-2 rounded-full bg-emerald-400 animate-ping"
            ></span>
            <span class="truncate max-w-[120px]" :title="userEmail">{{
              userEmail
            }}</span>
          </div>
          ...
          <button
            @click="handleLogout"
            class="text-slate-400 hover:text-red-400 hover:bg-red-500/10 p-2 rounded-xl transition-all outline-none ml-1"
    ...
    <Transition name="slide">
      ...
      >
        ...
        >
          <i class="fas fa-chart-pie w-5 opacity-70 text-center"></i> Dashboard
          Summary
        </router-link>
        <router-link
          to="/patients"
          ...
          class="text-slate-300 hover:text-white hover:bg-slate-800 p-3 rounded-xl transition-all flex items-center gap-3"
        >
          <i class="fas fa-user-injured w-5 opacity-70 text-center"></i> Patient
          Registry
        </router-link>
        <router-link
          to="/procedures"
...
<router-link
  ...
  class="text-slate-300 hover:text-white hover:bg-slate-800 p-3 rounded-xl transition-all flex items-center gap-3"
>
  <i class="fas fa-cog w-5 opacity-70 text-center"></i> Settings
</router-link>
        ...
        >
          <i class="fas fa-shield-alt text-slate-500"></i> Operator:
          {{ userEmail }}
        </div>
        ...
        >
          <i class="fas fa-sign-out-alt w-5 text-center"></i> Terminate Control
          Session
        </button>
      </div>
    </Transition>
